...
const fetchInvestmentDetail = async () => {
  ...
  try {
    ...
    console.log('📦 Investment Detail Response:', response); // 👈 For debugging
  ...
  const openActionModal = (action) => {
    const modalConfig = {
      approve: {
        ...
        message: `Are you sure you want to approve investment #${investment.investment_id}? Units will be allocated and funds deducted.`,
        requireReason: false
      },
      reject: {
  ...
  const handleInvestmentAction = async (reason) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setInvestment(response.data); // Update with latest data
  ...
  const canApprove = investment.status === 'pending';
      ...
      <div className="detail-card">
        <div className="card-header">
          ...
          <div className="card-header-right">
            ...
            <StatusBadge 
              status={investment.payment_completed ? 'completed' : 'pending'} 
              label={investment.payment_completed ? 'Payment Complete' : 'Payment Pending'}
            />
          </div>
        </div>
...
<div className="info-section">
  ...
  <div className="info-grid-detail">
    ...
    <div className="info-item-detail">
      ...
      <span className="info-value-detail">
        {investment.payment_completed ? '✓ Yes' : '✗ No'}
      </span>
    </div>
