    ...
    <>
      <div className="property-card">
        <div className="property-image-container">
          <div className="property-image-container">
            <img
              src={property.image || property.images?.[0] || property.primary_image || property.featured_image || 'https://via.placeholder.com/400x300?text=No+Image'}
              alt={property.name}
            ...
            <span className="type-badge">
              {property.property_type === 'residential' ? 'Residential' :
                property.property_type === 'commercial' ? 'Commercial' :
                  property.property_type === 'land' ? 'Plots' :
        ...
        <div className="property-content">
          ...
          <div className="property-details">
            ...
            <div className="detail-item">
              ...
              <span className="detail-value">
                ₹{Number(property.target_amount)?.toLocaleString('en-IN')}
              </span>
            </div>
          </div>
          ...
          <div className="property-metrics">
            ...
            <div className="metric">
              ...
              <span className="metric-value">{property.gross_yield || 0}%</span>
            </div>
            <div className="metric">
              <span className="metric-label">Target IRR</span>
              <span className="metric-value">{property.expected_return_percentage || 0}%</span>
            </div>
            <div className="metric">
              <span className="metric-label">Potential Gain</span>
              <span className={`metric-value ${property.potential_gain > 0 ? 'positive' : ''}`}>
                {property.potential_gain > 0 && (
                  <span className="gain-arrow">{renderIcon('arrowUp')}</span>
                )}
                {property.potential_gain || 0}%
              </span>
            </div>
      ...
      {showModal && (
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p>Our team will contact you shortly about <strong>{property.name}</strong>.</p>
